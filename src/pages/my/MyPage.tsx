  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      >
        ...
        >
          <div className="w-[250px] h-[250px] rounded-full bg-white/40 flex items-center justify-center">
            {avatarUrl ? (
              <img
                src={avatarUrl}
                alt="profile"
                className="w-[250px] h-[250px] rounded-full object-contain select-none"
                draggable={false}
              />
            ) : (
              <div className="w-[250px] h-[250px] rounded-full bg-white/30" />
            )}
          </div>
